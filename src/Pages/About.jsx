         ...
         <div className="container">
            <div className="row align-items-center">
               <div className="pl-4 col-lg-5 col-md-5 pr-4">
                  <img className="rounded img-fluid" src="images/about.jpg" alt="Card image cap"/>
               </div>
               <div className="col-lg-6 col-md-6 pl-5 pr-5">
                  <h2 className="mb-5">The leading global marketplace for learning and instruction
                  </h2>
            ...
            <div className="row">
               <div className="col-lg-4 col-md-4">
                  <div className="agents-card text-center">
                     <img className="img-fluid mb-4" src="images/user/s1.png" alt=""/>
               ...
               <div className="col-lg-4 col-md-4">
                  <div className="agents-card text-center">
                     <img className="img-fluid mb-4" src="images/user/s2.png" alt=""/>
                     <p className="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
               ...
               <div className="col-lg-4 col-md-4">
                  <div className="agents-card text-center">
                     <img className="img-fluid mb-4" src="images/user/s3.png" alt="" />
                     <p className="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
